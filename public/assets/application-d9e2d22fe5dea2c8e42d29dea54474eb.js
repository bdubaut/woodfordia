...
(function() {
  $(document).ready(function() {
    $('#scene_previous_scenes').chosen({
      allow_single_deselect: true,
      no_results_text: 'No results matched',
      width: '200px'
    });
    return $('#scene_next_scenes').chosen({
      allow_single_deselect: true,
      no_results_text: 'No results matched',
      width: '200px'
    });
...
(function() {
  ...
  $.getJSON("/statistics/sex_pie", function(data) {
    var ctx;
  ...
  $.getJSON("/statistics/virgin_pie", function(data) {
    var ctx;
  ...
  $.getJSON("/statistics/age_chart", function(data) {
    var ctx;
